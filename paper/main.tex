...
\end{equation}
$\Aset$ is the set of \emph{verifier} attestors that returned \Pass for the task (invoker attestation is asynchronous and does not affect immediate acceptance). Unknown attestors receive baseline rank 0.2. Default $\tauT=0.5$, $\alphaD=0.85$.
\end{definition}
